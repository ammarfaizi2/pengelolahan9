              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="?page=transaksi_siswa&aksi=bayar_bulanan_siswa&nis_siswa=<?php echo $nis; ?>&id_bayar=<?php echo $data['id_bayar'] ?>&id_tahun_ajaran=<?php echo $data['id_tahun_ajaran']; ?>" class="btn btn-info" title=""><i class="fa fa-eye"></i> Lihat Tagihan</a>
