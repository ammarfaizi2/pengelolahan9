    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-lg"><b>TATA USAHA</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
          ...
          if ($_SESSION['admin']) {
            ...
            $user = $_SESSION['user'];
          } elseif ($_SESSION['tatausaha']) {
            $user = $_SESSION['tatausaha'];
      ...
      <?php include "include/menutatausaha.php"; ?>
